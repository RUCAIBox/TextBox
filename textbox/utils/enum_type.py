...
PLM_MODELS = [
    # CLM_MODELS
    'gpt2', 'gpt', 'big_bird', 'bert', 'roberta', 'cpm', 'ctrl', 'xlnet', 'megatron_bert', 'transfo_xl', 'gpt_neo',
    # EncDecLM_MODELS
    't5', 'mt5', 'bart', 'mbart', 'bert2bert', 'big_bird_pegasus', 'pegasus', 'blender_bot', 'blender_bot_small',
    'led', 'm2m100', 'prophetnet',
]